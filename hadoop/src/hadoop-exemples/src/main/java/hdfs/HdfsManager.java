...
public class HdfsManager extends Configured implements Tool {
	...
	// hadoop jar $mapreducejarjob hdfs.HdfsManager read
	// /output/hdsfmanager/demo.txt ~/Desktop
	private void read(String pathInput, String pathOutput) throws IOException {
		...
		File file = new File(pathOutput + "/outputfile.txt");
		file.createNewFile();
	...
	// hadoop jar $mapreducejarjob hdfs.HdfsManager createDemoFile
	// /output/hdsfmanager
